...
df.to_excel('./KnownCarryingCapacityLogisticsModel_HaarioACMC_convergence_record'+current_date_and_time_string+'.xlsx')
...
plt.savefig('./KnownCarryingCapacityLogisticsModel_HaarioACMC_convergence_record'+current_date_and_time_string+'.png',dpi=500,bbox_inches = 'tight')
time_end=time.time()
